                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxOne"
                                                        class="text-base ml-2 text-slate-600">Design a FreshCart
                                                        Home page</label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxTwo"
                                                        class="text-base ml-2 text-slate-600">Dash UI Dark
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxThree"
                                                        class="text-base ml-2 text-slate-600">Dash UI landing
                                                        page design</label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxFour"
                                                        class="text-base ml-2 text-slate-600">Next.js Dash UI
                                                        version</label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxFive"
                                                        class="text-base ml-2 text-slate-600">Develop a Dash UI
                                                        Laravel</label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxSix"
                                                        class="text-base ml-2 text-slate-600">Coach home page
                                                        design</label>
                                                </div>
                                            </td>
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxSeven"
                                                        class="text-base ml-2 text-slate-600">Develop a Dash
                                                        UI Laravel</label>
                                                </div>
                                            </td>
