            ...
            <div class="w-full ">
                <div class="h-40 bg-indigo-600 py-2 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-baseline">
                    <div class="flex justify-between  items-baseline ">
                        <h1 class="text-white font-medium text-2xl max-sm:pl-2 max-sm:text-xl"> Mise a jour d'un
                            Abonnement
                        </h1>
                    </div>
                ...
                <form class="card  mt-[-50px] p-5 mx-4 mb-6" method="POST"
                    action="{{ route('abonnements.update',$abonnement->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2">
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="date_debut" class="block mt-1 w-full" type="date" name="date_debut"
                                :value="old('date_debut', $abonnement->date_debut)" required autofocus />
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2">
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <select name="client_id" id="client_id"
                                ...
                                <option @selected(old('client_id', $abonnement->menage->client_id) == $client->id)
                                    value="{{ $client->id }}"
                                    >
                                    {{ $client->user->nom }}
                                </option>
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="designation" class="block mt-1 w-full" type="text" name="designation"
                                :value="old('designation', $abonnement->menage->designation)" required />
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2">
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <select name="type_habitat_id" id="type_habitat_id"
                                class="block mt-1 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                                <option value="">Choisissez Le Type d'habitat</option>

                                @foreach ($type_habitats as $type_habitat)
                                <option @selected(old('type_habitat_id', $abonnement->menage->type_habitat_id) ==
                                    $type_habitat->id)
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <select name="quartier_id" id="quartier_id"
                                ...
                                <option @selected(old('quartier_id', $abonnement->menage->quartier_id) == $quartier->id)
                                    value="{{ $quartier->id }}"
                                    >
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2">
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="longitude" class="block mt-1 w-full" type="text" name="longitude"
                                :value="old('longitude', $abonnement->menage->longitude)" required />
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="latitude" class="block mt-1 w-full" type="text" name="latitude"
                                :value="old('latitude', $abonnement->menage->latitude)" required />
