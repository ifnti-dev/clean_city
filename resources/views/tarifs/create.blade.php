            ...
            <div class="w-full ">
                <div class="h-40 bg-indigo-600 py-2 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-baseline">
                    <div class="flex justify-between  items-baseline ">
                        <h1 class="text-white font-medium text-2xl max-sm:pl-2 max-sm:text-xl"> Creer un tarif
                        </h1>
                    </div>
                ...
                <form class="card  mt-[-50px] p-5 mx-4 mb-6" method="POST" action="{{ route('tarifs.store') }}">
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2">
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="designation" class="block mt-1 w-full" type="text" name="designation"
                                :value="old('designation')" required autofocus placeholder="Entrez la désignation" />
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="montant" class="block mt-1 w-full" type="number" name="montant"
                                :value="old('montant')" min="0" required placeholder="Entrez le montant" />
