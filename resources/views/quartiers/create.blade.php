            ...
            <div class="w-full ">
                <div class="h-40 bg-indigo-600 py-2 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-baseline">
                    <div class="flex justify-between  items-baseline ">
                        <h1 class="text-white font-medium text-2xl max-sm:pl-2 max-sm:text-xl"> Ajout d'un Quartier
                        </h1>
                    </div>
                ...
                <form class="card  mt-[-50px] p-5 mx-4 mb-6" method="POST" action="{{ route('quartiers.store') }}">
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2 ">
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <select name="zone_id" id="zone_id" class="w-full rounded-lg">
                                ...
                                <option @selected(old('zone_id',$zone_id)==$zone->id) value="{{ $zone->id }}">{{
