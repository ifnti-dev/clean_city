            ...
            <div class="w-full ">
                <div class="h-40 bg-indigo-600 py-2 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-baseline">
                    <div class="flex justify-between  items-baseline ">
                        <h1 class="text-white font-medium text-2xl max-sm:pl-2 max-sm:text-xl"> Creer un tournee
                        </h1>
                    </div>
                ...
                <form class="card  mt-[-50px] p-5 mx-4 mb-6" method="POST" action="{{ route('tournees.store') }}">
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2 ">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input-error :messages="$errors->get('employes_id')" class="mt-2" />
                        </div>
