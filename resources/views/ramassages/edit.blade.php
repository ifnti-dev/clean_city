    ...
    <x-slot>
        ...
        <div class=" flex justify-center items-center bg-white  rounded-md shadow m-6 p-6 lg:flex ">
            ...
            <div class="p-2 w-full ">
                ...
                <form method="POST" action="{{ route('ramassages.update',$ramassage->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2 ">
                        <div class="mt-4 w-full">
                            ...
                            <x-text-input id="date" class="block mt-1 w-full" type="date" name="date"
                                :value="old('date',$ramassage->date)" required autofocus autocomplete="family-name" />
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <select name="zone_id" id="zone_id" class="w-full rounded-lg">
                                ...
                                <option @selected($ramassage->zone_id==$zone->id) value="{{ $zone->id }}">{{
                    ...
                    <div class="grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:gap-2 ">
                        ...
                        <div class="mt-4">
                            ...
                            <select name="employe_id" id="employe_id" class="w-full rounded-lg">
                                ...
                                <option @selected($ramassage->employe_id==$employe->id) value="{{ $employe->id }}">{{
