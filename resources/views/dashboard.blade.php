                            ...
                            <tbody>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <div class="-space-x-5">
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-1.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-2.jpg" alt="Profile image" />
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <div class="-space-x-5">
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-4.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-5.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 border-2 rounded-full border-white"
                                                src="/public/assets/images/avatar/avatar-6.jpg" alt="Profile image" />
                                            <div
                                                class="relative w-8 h-8 bg-indigo-600 rounded-full inline-flex items-center justify-center text-white text-sm border-2 border-white">
                                                2+</div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <div class="-space-x-5">
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-7.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-8.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 border-2 rounded-full border-white"
                                                src="/public/assets/images/avatar/avatar-9.jpg" alt="Profile image" />
                                            <div
                                                class="relative w-8 h-8 bg-indigo-600 rounded-full inline-flex items-center justify-center text-white text-sm border-2 border-white">
                                                5+</div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <div class="-space-x-5">
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-10.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-11.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 border-2 rounded-full border-white"
                                                src="/public/assets/images/avatar/avatar-12.jpg" alt="Profile image" />
                                            <div
                                                class="relative w-8 h-8 bg-indigo-600 rounded-full inline-flex items-center justify-center text-white text-sm border-2 border-white">
                                                5+</div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <div class="-space-x-5">
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-13.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                                src="/public/assets/images/avatar/avatar-11.jpg" alt="Profile image" />
                                            <img class="relative inline-block object-cover w-8 h-8 border-2 rounded-full border-white"
                                                src="/public/assets/images/avatar/avatar-12.jpg" alt="Profile image" />
                        ...
                        <table class="text-left w-full whitespace-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">16 Sept, 2023
                                    </td>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <span
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">23 Sept, 2023
                                    </td>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <span
                                            class="bg-green-100 px-2 py-1 text-green-700 text-sm font-medium rounded-md">Approved</span>
                                ...
                                <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            ...
                                            <label for="checkboxFive" class="text-base ml-2 text-slate-600">Develop a
                                                Dash UI
                                                Laravel</label>
                                        </div>
                                    </td>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">20 Sept, 2023
                                    </td>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <span
                                            class="bg-red-100 px-2 py-1 text-red-700 text-sm font-medium rounded-md">Pending</span>
                                ...
                                <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <div class="flex items-center">
                                            ...
                                            <label for="checkboxSix" class="text-base ml-2 text-slate-600">Coach home
                                                page
                                                design</label>
                                        </div>
                                    </td>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">12 Sept, 2023
                                    </td>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <span
                                            class="bg-green-100 px-2 py-1 text-green-700 text-sm font-medium rounded-md">Approved</span>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">11 Sept, 2023
                                    </td>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                        <span
                                            class="bg-red-100 px-2 py-1 text-red-700 text-sm font-medium rounded-md">Pending</span>
                    ...
                    <table class="text-left w-full whitespace-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Project Director
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Today</td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="dropdown leading-4">
                            ...
                            <tr>
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Full- Stack
                                    Developer
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Yesterday</td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                            ...
                            <tr>
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Digital Marketer
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">3 May, 2023</td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="dropdown leading-4">
                            ...
                            <tr>
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Account Manager
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">3 May, 2023</td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="dropdown leading-4">
